package me.cazmat.morebabies.entity.ai.goal;

import me.cazmat.morebabies.entity.Sprog;
...
public class SprogMeleeAttackGoal extends Goal {
    protected final Sprog attacker;
    ...
    public SprogMeleeAttackGoal(Sprog entity, double speedIn, boolean useLongMemory) {
